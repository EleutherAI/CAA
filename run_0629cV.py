...
commands = {
    ...
    # 'alltokleace': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -2.75 .5 2.75) --type ab --unnormalized --all_tokens --leace', 
    # 'alltokorth': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -2.75 .5 2.75) --type ab --unnormalized --all_tokens --leace --method orth', 
    'allcaa': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -.275 .05 .275) --type ab --unnormalized',
    'allleace': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -2.75 .5 2.75) --type ab --unnormalized --leace',
    'allorth': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -2.75 .5 2.75) --type ab --unnormalized --leace --method orth',
    'basic': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -2.75 .5 2.75) --type ab --unnormalized',
    # 'layers': 'python prompting_with_steering.py --layers $(seq 10 20) --multipliers $(seq -3 .25 3) --type ab --unnormalized',
    'leace': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -2.75 .5 2.75) --type ab --unnormalized --leace',
    'orth': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -2.75 .5 2.75) --type ab --unnormalized --leace --method orth',
    ...
    # 'alltok': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -2.75 .5 2.75) --type ab --unnormalized --all_tokens', 
}
