...
commands = {
    ...
    # 'alltokleace': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .5 3) --type ab --unnormalized --all_tokens --leace', 
    # 'alltokorth': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .5 3) --type ab --unnormalized --all_tokens --leace --method orth', 
    'allcaa': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -.3 .05 .3) --type ab --unnormalized',
    'allleace': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -3 .5 3) --type ab --unnormalized --leace',
    'allorth': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -3 .5 3) --type ab --unnormalized --leace --method orth',
