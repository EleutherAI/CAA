...
commands = {
    ...
    'allcaa': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -.3 .025 .3) --type ab --unnormalized',
    ...
    'alltokleace': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .25 3) --type ab --unnormalized --all_tokens --leace', 
    'alltokorth': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .25 3) --type ab --unnormalized --all_tokens --leace --method orth', 
    'instr': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .25 3) --type ab --unnormalized --only_instr', 
    'instrleace': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .25 3) --type ab --unnormalized --only_instr --leace', 
    'instrorth': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .25 3) --type ab --unnormalized --only_instr --leace --method orth', 
}
...
# for job in list(commands.keys()):
#     cmd = commands[job]
#     cmd = cmd.replace("--type ab", "--type open_ended")
