...
commands = {
    ...
    'gen_acts13': 'python generate_vectors.py --layers $(seq 0 39) --model_size "13b" --save_activations',
    'gen_orth13': 'python generate_vectors.py --layers $(seq 0 39) --model_size "13b" --method orth',
    # 'gen_quad13': 'python generate_vectors.py --layers $(seq 0 39) --model_size "13b" --method quad',
    'gen_logit13': 'python generate_vectors.py --layers $(seq 0 39) --model_size "13b" --logit',
    ...
    'layers': 'python prompting_with_steering.py --layers $(seq 10 20) --multipliers $(seq -3 .5 3) --type ab --unnormalized',
    ...
    'quadlda': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .5 3) --type ab --unnormalized --classify lda --leace --method quad',
...
for job in list(commands.keys()):
    if job.startswith("gen_"):
        continue
    if job.startswith("quad") or job.startswith("qall"):
        continue
...
dependencies['allcaa13'] = ['gen_acts13']
dependencies['allleace13'] = ['gen_acts13']
dependencies['basic13'] = ['gen_acts13']
dependencies['layers13'] = ['gen_acts13']
dependencies['leace13'] = ['gen_acts13']
dependencies['orth13'] = ['gen_orth13']
dependencies['logit13'] = ['gen_logit13']
dependencies['class13'] = ['gen_acts13']
dependencies['lda13'] = ['gen_acts13']
dependencies['alltok13'] = ['gen_acts13']



for job in commands:
    commands[job] += f"> logs/0624b_{job}.log 2>&1"
