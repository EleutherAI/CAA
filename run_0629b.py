...
commands = {
    ...
    # 'alltokleace': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .5 3) --type open_ended --unnormalized --all_tokens --leace', 
    # 'alltokorth': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .5 3) --type open_ended --unnormalized --all_tokens --leace --method orth', 
    'allcaa': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -.3 .05 .3) --type open_ended --unnormalized',
    'allleace': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -3 .5 3) --type open_ended --unnormalized --leace',
    'allorth': f'python prompting_with_steering.py --layers -1 --multipliers $(seq -3 .5 3) --type open_ended --unnormalized --leace --method orth',
    'basic': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .5 3) --type open_ended --unnormalized',
    # 'layers': 'python prompting_with_steering.py --layers $(seq 10 20) --multipliers $(seq -3 .25 3) --type open_ended --unnormalized',
    'leace': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .5 3) --type open_ended --unnormalized --leace',
    'orth': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .5 3) --type open_ended --unnormalized --leace --method orth',
    ...
    # 'alltok': 'python prompting_with_steering.py --layers 13 --multipliers $(seq -3 .5 3) --type open_ended --unnormalized --all_tokens', 
}
